...
RedactorPlugins.fontcolor = function () {
  return {
    ...
    init: function () {
      ...
      // if define custom colors, override them.
      if (this.opts.fontcolorLists) {
        colors = this.opts.fontcolorLists;
      }

      // if define custom bgcolors, override them.
      if (this.opts.bgcolorLists) {
        bgcolors = this.opts.bgcolorLists;
      }

      var $button = this.button.addBefore('format', 'fontcolor', this.lang.get('textcolorbutton'));
      ...
      var $selectorText = $('<span rel="text" class="re-dropdown-box-selector-font" style="background: #eee; float: left; padding: 8px 0; cursor: pointer; font-size: 12px; width: 50%;">' + this.lang.get('textcolor') + '</span>');
      ...
      this.fontcolor.buildPicker($dropdown, 'backcolor', bgcolors);
    ...
    buildPicker: function ($dropdown, name, colors) {
      ...
      var $elNone = $('<a href="#" style="display: block; clear: both; padding: 8px 5px; box-sizing: border-box; font-size: 12px; line-height: 1;"></a>').html(this.lang.get('resetcolor'));
